...
Tested on the **Miyoo Mini Plus** running **Onion OS**. The button key codes are specific to the Mini Plus — the original Miyoo Mini uses different codes and would need `zoom_daemon.c` edited and rebuilt.

## The story

This is my first piece of software. I'm not a programmer — I'm an artist and designer who wanted to look closer at pixel art on a handheld, was told that wasn't a thing, and decided it should be. It took a cross-compiler, a button-code detector, one stubborn double-buffering bug, and a lot of swearing. Worth it.

Built with the help of an AI pair programmer (Claude). The bugs were a team effort too.
